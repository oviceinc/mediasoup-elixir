defmodule ConsumerTest do
  ...
  setup do
    ...
    %{worker: worker, router: router, transport_1: transport_1, transport_2: transport_2}
  end

  test "consume_succeeds", %{
    worker: _worker,
    router: router,
  ...
  test "set_unset_priority_succeeds", %{
    worker: _worker,
    router: router,
    transport_1: transport_1,
    transport_2: transport_2
